...
export const performance = {
    queries: [
        {
            category: "Online Delivery Issues",
            items: [
                "My order was late by 30 minutes.",
                "The delivery person was rude.",
                "I received the wrong order.",
                "Food was spilled inside the packaging.",
            ],
        },
        {
            category: "Food App & Menu Issues",
            items: [
                "The dish looks nothing like the picture in the app.",
                "Portion size is smaller than shown.",
                "Items show available but are out of stock.",
            ],
        },
        {
            category: "Food Quality Complaints",
            items: [
                "The food tasted stale, not fresh.",
                "There was a hair in my food!",
                "The food was too salty/spicy despite my request.",
            ],
        },
        {
            category: "Food Quality Complaints",
